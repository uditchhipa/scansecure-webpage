...
import { UserPlus, Shield, AlertCircle, Github, ArrowLeft } from "lucide-react";
            ...
            <div className="hidden lg:flex lg:w-1/2 relative bg-black items-center justify-center border-r border-white/5 overflow-hidden">
                ...
                <div className="relative z-10 p-12 max-w-lg">
                    ...
                    <p className="text-slate-500 text-lg leading-relaxed font-light">
                        Create your account today to access real-time vulnerability scanning,
                        document analysis, and secure metadata tools.
                    </p>
                </div>
            </div>
            ...
            <div className="w-full lg:w-1/2 flex flex-col p-6 md:p-12 lg:p-24 justify-center relative">
                ...
                <div className="max-w-[400px] w-full mx-auto">
                    <div className="mb-10 text-center">
                        ...
                        <p className="text-slate-500 text-sm">Sign up for free with:</p>
                    </div>
                    ...
                    <div className="relative mb-8">
                        ...
                        <div className="relative flex justify-center text-[10px] uppercase font-medium tracking-wider">
                            <span className="bg-[#030303] px-3 text-slate-500">Or sign up with email</span>
                        </div>
                    </div>
                    ...
                    <form onSubmit={handleRegister} className="space-y-5">
                        ...
                        <div className="space-y-1.5">
                            <label className="block text-xs font-light text-slate-400 ml-0.5">Password</label>
                            <input
                                type="password"
                                required
                                minLength={6}
