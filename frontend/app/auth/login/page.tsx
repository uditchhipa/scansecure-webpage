        ...
        <div className="min-h-screen bg-slate-950 text-slate-100 flex items-center justify-center p-4 relative overflow-hidden">
            ...
            <div className="z-10 w-full max-w-md bg-slate-900/50 backdrop-blur-xl border border-white/10 p-8 rounded-3xl shadow-2xl">
                ...
                <form onSubmit={handleLogin} className="space-y-4">
                    ...
                    <div>
                        ...
                        <div className="text-right mt-1">
                            <Link href="/auth/forgot-password" className="text-[10px] text-emerald-400 hover:text-emerald-300 hover:shadow-[0_0_10px_rgba(16,185,129,0.4)] font-bold tracking-wide transition-all">
                                FORGOT PASSWORD?
                            </Link>
                        </div>
                    </div>
                ...
                <div className="mt-8 text-center text-sm text-slate-500">
                    ...
                    <Link href="/auth/register" className="text-emerald-400 hover:text-emerald-300 font-medium transition-colors hover:shadow-[0_0_10px_rgba(16,185,129,0.4)]">
                        Initialize Protocol
                    </Link>
                </div>
            </div>
